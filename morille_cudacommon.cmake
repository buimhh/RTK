...
set(CTEST_SOURCE_DIRECTORY "C:\\src\\rtk\\ITKCudaCommon")
set(MSVC_VERSION 16)
set(MSVC_YEAR 2019)
  ...
  foreach(DEBUG_RELEASE "Release" "Debug")
    ...
    foreach(FFTW OFF ON)
      foreach(STATIC_SHARED "Shared" "Static")
        ...
        set(CTEST_BUILD_NAME "CudaCommon-Windows7-64bit-MSVC${MSVC-VERSION}-ITK${ITK_VERSION}-${STATIC_SHARED}-${DEBUG_RELEASE}-FFTW${FFTW}")
        set(CTEST_BINARY_DIRECTORY "C:\\src\\rtk\\CudaCommon-${MSVC_YEAR}-${ITK_VERSION}-${STATIC_SHARED}-${DEBUG_RELEASE}-FFTW${FFTW}")
